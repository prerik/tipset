...
class TopListWidget extends WP_Widget {

    public function __construct() {
        parent::__construct(
                'toplistwidget', // Base ID
                'Tipset topplista', // Name
                array('description' => __('Widget för att visa topplista', 'text_domain'),) // Args
        );
    }

    public function form($instance) {
        /* Set up some default widget settings. */
        $defaults = array('title' => 'Topplistan');
    ...
    function getContent() {
        ...
        $querystring = "SELECT results.users_id as userid, CONCAT(first_name.meta_value, ' ', last_name.meta_value) AS namn, SUM(results.points) AS poang " .
                ...
                "GROUP BY results.users_id ORDER BY poang DESC, last_name.meta_value ASC LIMIT 5";
